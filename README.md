...
---
----------------------- ------------------------------------
> :warning: **NOTE TO ALL MAKERS**: I review and sometimes revise models while I prepare video tutorials on how to make a module. For that reason I advise anyone building PUMA parts to wait until the video tutorial for that part is on YouTube otherwise you may be printing parts that are out of date and not optimum (and may need to reprint components). Also there are specific techniques to building that must be followed for best results and are not obvious from looking at the CAD models. Please be patient and follow the video tutorial advice to avoid disappointment! **Currently I am revising the binocular head modules and revised models are being prepared for this including the binocular head beam splitter. The video on the ocular heads is next in line to be released and the new models will be placed here on GitHub just prior to release of that video when it is ready.**
----------------------------------------------------------------
